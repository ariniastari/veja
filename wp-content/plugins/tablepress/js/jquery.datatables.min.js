    ...
    var O = function(g) {
        ...
        function nb(a) {
            var b = a.oClasses,
                ...
                d = a.oPreviousSearch,
                f = a.aanFeatures,
                h = '<div class="col-md-6"><h1 style="margin-bottom: 40px;">Leaderboard</h1></div><div class="col-md-6"><div class="form-search"><div class="inner-addon right-addon"><i class="glyphicon glyphicon-search pink"></i><input type="search" class="form-control ' + b.sFilterInput + '"/></div></div></div><div class="col-md-12"><p>Hi Supermama, sudah kirim atau masukkan kode unik Anda? Nantikan akumulasi poin Anda setiap dua minggu sekali, pada hari Kamis. Kumpulkan terus poin mama, dan raih kesempatan menangkan hadiah menarik dari Veja</p><br/>',
                i = e.sSearch,
                i = i.match(/_INPUT_/) ? i.replace("_INPUT_", h) : h,
                b = g("<div/>", {
                    id: !f.f ? c + "_filter" : null,
                    "class": b.sFilter
                }).append(g("<div/>").append(i)),
                f = function() {
        ...
        p.defaults = {
            ...
            oLanguage: {
                ...
                sSearch: "Search:",
                sSearchPlaceholder: "Cari nama Mama disini",
                sUrl: "",
