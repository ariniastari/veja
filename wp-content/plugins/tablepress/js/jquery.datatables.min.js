    ...
    var O = function(g) {
        ...
        function nb(a) {
            var b = a.oClasses,
                ...
                d = a.oPreviousSearch,
                f = a.aanFeatures,
                h = '<div class="col-md-6"><h1 style="margin-bottom: 40px;">Leaderboard</h1></div><div class="col-md-6"><div class="form-search"><div class="inner-addon right-addon"><i class="glyphicon glyphicon-search pink"></i><input type="search" class="form-control ' + b.sFilterInput + '"/></div></div>',
                i = e.sSearch,
